...
export const topClickedFetchStart = createAction(SuggestedStationsActions.TopClickedFetchStart);
...
export const topVotedFetchStart = createAction(SuggestedStationsActions.TopVotedFetchStart);
