...
export const radioBrowserSearchState = createFeatureSelector<RadioBrowserSearchState>(
  radioBrowserSearchFeatureKey
);

export const selectedCountry = createSelector(radioBrowserSearchState, state => state.country);
...
export const listedCountries = createSelector(radioBrowserSearchState, state => state.countries);

export const countryFilter = createSelector(radioBrowserSearchState, state => state.countryFilter);
