...
export const fetchStationsSubmit = createAction(FavoriteStationsActions.FetchStationsSubmit);

export const fetchStationsStart = createAction(FavoriteStationsActions.FetchStationsStart);
...
export const openStationEditNew = createAction(FavoriteStationsActions.OpenStationEditNew);

export const openStationEditCurrent = createAction(FavoriteStationsActions.OpenStationEditCurrent);
...
export const closeStationEdit = createAction(FavoriteStationsActions.CloseStationEdit);
