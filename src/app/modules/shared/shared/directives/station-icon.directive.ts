import { Directive, Input, OnChanges, HostBinding, SimpleChanges, HostListener, OnInit, OnDestroy } from '@angular/core';
...
export class StationIconDirective implements OnChanges, OnInit, OnDestroy {
  ...
  private proxiedIconUrl$ = this.iconUrlAsync.pipe(
    ...
    switchMap(iconUrl => this.configService.appConfig$.pipe(
