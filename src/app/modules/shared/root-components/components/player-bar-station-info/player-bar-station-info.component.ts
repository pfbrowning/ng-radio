...
export class PlayerBarStationInfoComponent
    ...
    private checkApplyMarquees() {
        ...
        this.titleMarquee = this.isElementOverflowingX(
            this.titleElement.nativeElement
        )
        this.stationMarquee = this.isElementOverflowingX(
            this.stationElement.nativeElement
        )
    ...
    in order to bind the marquee classes to the template. */
        if (
            this.titleMarquee !== titleMarqueeBefore ||
            this.stationMarquee !== stationMarqueeBefore
        ) {
